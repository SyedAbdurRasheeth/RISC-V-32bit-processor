...
VL_ATTR_COLD void Vloadstore_tb___024root___eval_static(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___eval_static\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

VL_ATTR_COLD void Vloadstore_tb___024root___eval_final(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___eval_final\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vloadstore_tb___024root___dump_triggers__stl(Vloadstore_tb___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vloadstore_tb___024root___eval_phase__stl(Vloadstore_tb___024root* vlSelf);

VL_ATTR_COLD void Vloadstore_tb___024root___eval_settle(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___eval_settle\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vloadstore_tb___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("tb/loadstore_tb.v", 3, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vloadstore_tb___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vloadstore_tb___024root___dump_triggers__stl(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___dump_triggers__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vloadstore_tb___024root___stl_sequent__TOP__0(Vloadstore_tb___024root* vlSelf);

VL_ATTR_COLD void Vloadstore_tb___024root___eval_stl(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___eval_stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vloadstore_tb___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD void Vloadstore_tb___024root___stl_sequent__TOP__0(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___stl_sequent__TOP__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vloadstore_tb___024root___eval_triggers__stl(Vloadstore_tb___024root* vlSelf);

VL_ATTR_COLD bool Vloadstore_tb___024root___eval_phase__stl(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___eval_phase__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vloadstore_tb___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vloadstore_tb___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vloadstore_tb___024root___dump_triggers__act(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___dump_triggers__act\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge loadstore_tb.clk)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge loadstore_tb.rst)\n");
    }
...
VL_ATTR_COLD void Vloadstore_tb___024root___dump_triggers__nba(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___dump_triggers__nba\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge loadstore_tb.clk)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge loadstore_tb.rst)\n");
    }
...
VL_ATTR_COLD void Vloadstore_tb___024root___ctor_var_reset(Vloadstore_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vloadstore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vloadstore_tb___024root___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->loadstore_tb__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__rst = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__pc = VL_RAND_RESET_I(32);
    vlSelf->loadstore_tb__DOT__dut__DOT__next_pc = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 1024; ++__Vi0) {
        vlSelf->loadstore_tb__DOT__dut__DOT__imem[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->loadstore_tb__DOT__dut__DOT__rd = VL_RAND_RESET_I(5);
    vlSelf->loadstore_tb__DOT__dut__DOT__funct3 = VL_RAND_RESET_I(3);
    vlSelf->loadstore_tb__DOT__dut__DOT__rs1 = VL_RAND_RESET_I(5);
    vlSelf->loadstore_tb__DOT__dut__DOT__rs2 = VL_RAND_RESET_I(5);
    vlSelf->loadstore_tb__DOT__dut__DOT__reg_write = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__alu_src = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__mem_read = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__mem_write = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__branch = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__jump = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__jalr = VL_RAND_RESET_I(1);
    vlSelf->loadstore_tb__DOT__dut__DOT__alu_ctrl = VL_RAND_RESET_I(4);
    vlSelf->loadstore_tb__DOT__dut__DOT__wb_sel = VL_RAND_RESET_I(2);
    vlSelf->loadstore_tb__DOT__dut__DOT__alu_a_sel = VL_RAND_RESET_I(2);
    vlSelf->loadstore_tb__DOT__dut__DOT__im_out = VL_RAND_RESET_I(32);
    vlSelf->loadstore_tb__DOT__dut__DOT__rs2_rdata = VL_RAND_RESET_I(32);
    vlSelf->loadstore_tb__DOT__dut__DOT__alu_result = VL_RAND_RESET_I(32);
    vlSelf->loadstore_tb__DOT__dut__DOT__mem_rdata = VL_RAND_RESET_I(32);
    vlSelf->loadstore_tb__DOT__dut__DOT____VdfgRegularize_hff2ff239_0_1 = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->loadstore_tb__DOT__dut__DOT__rf__DOT__regs[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 4096; ++__Vi0) {
        vlSelf->loadstore_tb__DOT__dut__DOT__mem__DOT__mem[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->__Vtrigprevexpr___TOP__loadstore_tb__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__loadstore_tb__DOT__rst__0 = VL_RAND_RESET_I(1);
}
