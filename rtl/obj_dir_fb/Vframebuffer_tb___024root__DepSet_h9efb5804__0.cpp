...
void Vframebuffer_tb___024root___eval_triggers__act(Vframebuffer_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vframebuffer_tb___024root___eval_triggers__act\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, ((IData)(vlSelfRef.framebuffer_tb__DOT__dut__DOT__clk_25mhz) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__framebuffer_tb__DOT__dut__DOT__clk_25mhz__0))));
    vlSelfRef.__VactTriggered.set(1U, ((IData)(vlSelfRef.framebuffer_tb__DOT__clk_100mhz) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__framebuffer_tb__DOT__clk_100mhz__0))));
    vlSelfRef.__VactTriggered.set(2U, ((IData)(vlSelfRef.framebuffer_tb__DOT__rst) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__framebuffer_tb__DOT__rst__0))));
