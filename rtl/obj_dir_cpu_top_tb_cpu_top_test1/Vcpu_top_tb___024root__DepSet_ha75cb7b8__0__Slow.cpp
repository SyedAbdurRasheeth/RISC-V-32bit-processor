...
VL_ATTR_COLD void Vcpu_top_tb___024root___eval_initial__TOP(Vcpu_top_tb___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ cpu_top_tb__DOT__dut__DOT__mem__DOT__i;
    cpu_top_tb__DOT__dut__DOT__mem__DOT__i = 0;
    ...
    VL_PRINTF_MT("-Info: tb/cpu_top_tb.v:86: $dumpvar ignored, as Verilated without --trace\n");
    VL_READMEM_N(true, 32, 1024, 0, VL_CVT_PACK_STR_NW(11, Vcpu_top_tb__ConstPool__CONST_hd957b626_0)
    ...
    cpu_top_tb__DOT__dut__DOT__mem__DOT__i = 0U;
    while (VL_GTS_III(32, 0x1000U, cpu_top_tb__DOT__dut__DOT__mem__DOT__i)) {
        vlSelfRef.cpu_top_tb__DOT__dut__DOT__mem__DOT__mem[(0xfffU 
                                                            & cpu_top_tb__DOT__dut__DOT__mem__DOT__i)] = 0U;
        cpu_top_tb__DOT__dut__DOT__mem__DOT__i = ((IData)(1U) 
                                                  + cpu_top_tb__DOT__dut__DOT__mem__DOT__i);
    }
}
