...
VL_ATTR_COLD void Vcpu_top_tb___024root___eval_initial__TOP(Vcpu_top_tb___024root* vlSelf) {
    ...
    VL_PRINTF_MT("-Info: tb/cpu_top_tb.v:52: $dumpvar ignored, as Verilated without --trace\n");
    __Vtemp_2[0U] = 0x68657822U;
    __Vtemp_2[1U] = 0x72616d2eU;
    __Vtemp_2[2U] = 0x70726f67U;
    __Vtemp_2[3U] = 0x22U;
    VL_READMEM_N(true, 32, 1024, 0, VL_CVT_PACK_STR_NW(4, __Vtemp_2)
