...
class alignas(VL_CACHE_LINE_BYTES) Vbranch_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ branch_tb__DOT__dut__DOT__jump;
    CData/*0:0*/ branch_tb__DOT__dut__DOT__jalr;
    CData/*3:0*/ branch_tb__DOT__dut__DOT__alu_ctrl;
    CData/*1:0*/ branch_tb__DOT__dut__DOT__wb_sel;
    CData/*1:0*/ branch_tb__DOT__dut__DOT__alu_a_sel;
    ...
    IData/*31:0*/ branch_tb__DOT__dut__DOT____VdfgRegularize_hff2ff239_0_1;
